...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'logs_logentry', (
        ...
        db.send_create_signal(u'logs', ['LogEntry'])

        # Adding model 'Event'
        db.create_table(u'logs_event', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('entry', self.gf('django.db.models.fields.related.ForeignKey')(related_name='events', to=orm['logs.LogEntry'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'logs', ['Event'])


    def backwards(self, orm):
        # Deleting model 'LogEntry'
        db.delete_table(u'logs_logentry')

        # Deleting model 'Event'
        db.delete_table(u'logs_event')
    ...
    models = {
        ...
        u'logs.event': {
            ...
            'entry': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'events'", 'to': u"orm['logs.LogEntry']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
